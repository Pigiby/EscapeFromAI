...
The Judge sees the full conversation history up to and including the latest
player turn, and outputs:
...
def _format_conversation(history: list[Message], latest_player_line: str) -> str:
    ...
    from .llm import _trim_history  # share the same window policy as VOX
